		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#commindsetappsproject9-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commindsetappsproject9-display": {
								"semanticObject": "commindsetappsproject9",
								"action": "display",
								"description": "A Fiori application which uses Array union interaction with examples",
								"title": "App Title",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mindset.apps.project9",
									"url": sap.ui.require.toUrl("com/mindset/apps/project9")
								}
							}
						}
					}
